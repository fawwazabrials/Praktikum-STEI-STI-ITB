...
inverse :: [Char] -> [Char]
{-  inverse menerima masukan sebuah list of character, misalnya lc, dan 
    menghasilkan list, misalnya lc’, yang berisi elemen-elemen lc dengan 
    urutan yang dibalik. Jika lc = [e1,e2,...en-1,en] maka lc’ = 
    [en,en-1,...,e2,e1]. -}
